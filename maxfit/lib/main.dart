...
class WorkoutsList  extends StatelessWidget {
  ...
  final workouts = <Workout>[
    Workout(title: 'Test 1', auhtor: 'Max 1', description: 'Test Workout 1', level: 'Beginner'),
    Workout(title: 'Test 2', auhtor: 'Max 2', description: 'Test Workout 2', level: 'Intermediate'),
    Workout(title: 'Test 3', auhtor: 'Max 3', description: 'Test Workout 3', level: 'Advancet'),
    Workout(title: 'Test 4', auhtor: 'Max 4', description: 'Test Workout 4', level: 'Beginner'),
    Workout(title: 'Test 5', auhtor: 'Max 5', description: 'Test Workout 5', level: 'Intermediate'),
  ];
